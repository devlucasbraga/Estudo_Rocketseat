  ...
  return (
    <>
      ...
      {editor && (
        <FloatingMenu
          editor={editor}
          className="bg-zinc-700 py-2 px-1  gap-1 shadow-xl border border-zinc-600 shadow-black/20 roudend-lg overflow-hidden flex flex-col"
          shouldShow={({ state }) => {
      ...
      {editor && (
        <BubbleMenu
          className="bg-zinc-700 shadow-xl border border-zinc-600 shadow-black/20 roudend-lg overflow-hidden flex divide-x divide-zinc-600"
          editor={editor}
        >
          <BubbleButton>
            Text
